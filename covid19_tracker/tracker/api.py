...
class API:
    ...
    def get_live(self):
        ...
        """
        url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vR30F8lYP3jG7YOq8es0PBpJIE5yvRVZffOyaqC0GgMBN6yt0Q-NI8pxS7hd1F9dYXnowSC6zpZmW9D/pubhtml/sheet?headers=false&gid=0&range=A7:I203"
        req = requests.get(url)
        soup = BeautifulSoup(req.text, 'html.parser')
